    ...
    <div className=" my-[180px] w-full ">
      <div className="flex flex-col justify-center items-center  container">
        ...
        <div className="lg:text-4xl text-xl w-full lg:w-auto ">
          <form className="my-4 lg:my-16 lg:w-[683px] w-full flex flex-col md:flex-row">
            <TextInput
              size="lg"
              placeholder="example"
            ...
            <button className="bg-[#FF7A00] md:rounded-r-md  s:p-2 flex items-center justify-center md:px-6">
